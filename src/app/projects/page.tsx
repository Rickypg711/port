  ...
  return (
    ...
    <div>
      ...
      <div className="nav-left-item nav-links  ml-7 mr-4 text-teal-200 text-xl">
        <button className="text-2xl text-teal-200 hover:text-violet-200 focus:outline-none" onClick={toggleMenu}>
          <FaBars />
        </button>
        <div
          className={`${
        ...
        >
          <Link href="/about" className="block px-4 py-2 text-gray-800 hover:bg-violet-200 hover:text-white">
            About
          </Link>
          <Link href="/projects" className="block px-4 py-2 text-gray-800 hover:bg-violet-200 hover:text-white">
            Projects
          </Link>
          <Link href="/blog" className="block px-4 py-2 text-gray-800 hover:bg-violet-200 hover:text-white">
            Blog
          </Link>
        </div>
      </div>
