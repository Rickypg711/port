...
export default function Home() {
  return (
    <div>
      ...
      {/*  */}
      <section className=" bg-slate-800 py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="max-w-3xl mx-auto">
    <h1 className={`${playFairDisplay.className} text-3xl font-bold  text-violet-200  mb-5`}>
            About Me
          </h1>
          <p className="text-violet-200  mb-8">
            Hey, Im Ricardo. Most folks know me as <b className="text-teal-200">aztec Warrior</b> online.
          </p>
          <div className=" text-violet-200  mb-8">
            <p>
              Im currently the <b className={`${playFairDisplay.className} font-bold text-teal-200`}>VP of Developer Experience at my own thing</b>
              , where I lead our Developer Relations and Documentation teams. I
              focus on <b className={`${playFairDisplay.className} font-bold text-teal-200`}>educating and growing</b> communities.
            </p>
            ...
            <p>
              ...
              things as a developer in this communities.
            </p>
            <p>
              <b className={`${playFairDisplay.className} font-bold text-teal-200`}>I love</b> building for the web. From something as simple as a
            ...
            <p>
              Outside of Web development, I <b className={`${playFairDisplay.className} font-bold text-teal-200`}>angel invest</b> in developer
              tools companies and <b className={`${playFairDisplay.className} font-bold text-teal-200`}>advise early-stage startups</b>. I also do
